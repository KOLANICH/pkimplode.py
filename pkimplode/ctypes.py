...
def _getFieldsForInternalStateStructure(commonSizes: CommonSizeConstants, lutSizes: LUTSizeConstants, sizeConstants):  # pylint:disable=redefined-outer-name
	return [
		...
		("dist_bits", ctypes.c_ubyte * lutSizes.DIST_SIZES),
		("dist_codes", ctypes.c_ubyte * lutSizes.DIST_SIZES),
		...
		("out_buff", ctypes.c_char * commonSizes.OUT_BUFF_SIZE),
		("work_buff", ctypes.c_ubyte * commonSizes.BUFF_SIZE),
		("phash_offs", ctypes.c_ushort * commonSizes.BUFF_SIZE),
	]
